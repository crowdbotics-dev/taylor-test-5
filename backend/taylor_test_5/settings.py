"""
Django settings for taylor_test_5 project.
...
ROOT_URLCONF = 'taylor_test_5.urls'
...
WSGI_APPLICATION = 'taylor_test_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Taylor-Test Support <support@taylor-test-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taylor_test_5 API",
    "DESCRIPTION": "API documentation for taylor_test_5 App",
    "VERSION": "v1",
}
